...
class ParserTest {
    ...
    public void testUpdateGeometry() throws ParsingException {
        String s = "S1 foo v 0.5 0.5 0.5 0.5 0.5 -0.5 0.5 -0.5 0.5 0.5 -0.5 -0.5 -0.5 0.5 0.5 -0.5 0.5 -0.5 -0.5 -0.5 0.5 -0.5 -0.5 -0.5   p -0.465155 0.475745 1.15673 r 0 0 0 1  s 0.106014 0.106025 0.11345 c 1 2 3 b 3.4 t foo l 2 w 4.2";
        List<Parser.Command> actual = Parser.parse(List.of(s.split("\\s+")));
        List<Parser.Command> expected = List.of(new Parser.UpdateGeometryCommand(new Parser.NameMatcher("S1", Parser.NameMatchType.WILDCARD), new Parser.NameMatcher("foo", Parser.NameMatchType.WILDCARD), List.of(-0.465155, 0.475745, 1.15673), List.of(0.0, 0.0, 0.0, 1.0), List.of(0.106014, 0.106025, 0.11345), List.of(1d, 2d, 3d), List.of(new Vertex(0.5, 0.5, 0.5), new Vertex(0.5, 0.5, -0.5), new Vertex(0.5, -0.5, 0.5), new Vertex(0.5, -0.5, -0.5), new Vertex(-0.5, 0.5, 0.5), new Vertex(-0.5, 0.5, -0.5), new Vertex(-0.5, -0.5, 0.5), new Vertex(-0.5, -0.5, -0.5)), 3.4, "foo", 2, 4.2));
